				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li><a href="./state_saving.php">State saving</a></li>
							<li><a href="./large_js_source.php">Client-side data source (50,000 rows)</a></li>
							<li><a href="./server-side_processing.php">Server-side processing (5,000,000
							rows)</a></li>
							<li><a href="./api_scrolling.php">API</a></li>
						</ul>
					</div>
				</div>
