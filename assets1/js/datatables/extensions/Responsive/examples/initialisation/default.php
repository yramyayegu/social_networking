	...
	<section>
		<div class="footer">
			...
			<div class="liner">
				...
				<div class="toc">
					<div class="toc-group">
						<h3><a href="./index.php">Basic initialisation</a></h3>
						<ul class="toc active">
							<li><a href="./className.php">Class name</a></li>
							<li><a href="./option.php">Configuration option</a></li>
							<li><a href="./new.php">`new` constructor</a></li>
							<li><a href="./ajax.php">Ajax data</a></li>
							<li class="active"><a href="./default.php">Default initialisation</a></li>
						</ul>
					</div>
