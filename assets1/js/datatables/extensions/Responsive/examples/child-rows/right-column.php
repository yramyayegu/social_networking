		...
		<div class="footer">
			...
			<div class="liner">
				...
				<div class="toc">
					...
					<div class="toc-group">
						<h3><a href="./index.php">Child rows</a></h3>
						<ul class="toc active">
							<li><a href="./disable-child-rows.php">Disable child rows</a></li>
							<li><a href="./column-control.php">Column controlled child rows</a></li>
							<li class="active"><a href="./right-column.php">Column control - right</a></li>
							<li><a href="./whole-row-control.php">Whole row child row control</a></li>
							<li><a href="./custom-renderer.php">Custom child row renderer</a></li>
						</ul>
					</div>
				</div>
