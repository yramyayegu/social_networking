...
$(document).ready(function() {
	...
	$('#example thead tr:eq(0) th:eq(2)').php("This is a really long column title!");
		...
		<div class="footer">
			...
			<div class="liner">
				...
				<div class="toc">
					...
					<div class="toc-group">
						<h3><a href="./index.php">Display control</a></h3>
						<ul class="toc active">
							<li><a href="./auto.php">Automatic column hiding</a></li>
							<li><a href="./classes.php">Class control</a></li>
							<li><a href="./init-classes.php">Assigned class control</a></li>
							<li><a href="./fixedHeader.php">With FixedHeader</a></li>
							<li class="active"><a href="./complexHeader.php">Complex headers (rowspan / colspan)</a></li>
						</ul>
					</div>
