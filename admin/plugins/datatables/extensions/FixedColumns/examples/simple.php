			...
			<div class="liner">
				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							<li><a href="./left_right_columns.php">Left and right fixed columns</a></li>
							<li class="active"><a href="./simple.php">Basic initialisation</a></li>
							<li><a href="./two_columns.php">Multiple fixed columns</a></li>
							<li><a href="./right_column.php">Right column only</a></li>
							<li><a href="./rowspan.php">Complex headers</a></li>
							<li><a href="./colvis.php">ColVis integration</a></li>
							<li><a href="./server-side-processing.php">Server-side processing</a></li>
							<li><a href="./css_size.php">CSS row sizing</a></li>
							<li><a href="./size_fixed.php">Assigned column width</a></li>
							<li><a href="./size_fluid.php">Fluid column width</a></li>
							<li><a href="./col_filter.php">Individual column filtering</a></li>
							<li><a href="./bootstrap.php">Bootstrap</a></li>
							<li><a href="./index_column.php">Index column</a></li>
						</ul>
					</div>
				</div>
