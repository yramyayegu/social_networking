				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li><a href="./new_init.php">Initialisation using `new`</a></li>
							<li><a href="./alt_insert.php">Alternative insert styling</a></li>
							<li><a href="./realtime.php">Realtime updating</a></li>
							<li><a href="./state_save.php">State saving</a></li>
							<li><a href="./scrolling.php">Scrolling table</a></li>
							<li><a href="./predefined.php">Predefined column ordering</a></li>
							<li><a href="./reset.php">Reset ordering API</a></li>
							<li><a href="./colvis.php">ColVis integration</a></li>
							<li><a href="./fixedcolumns.php">FixedColumns integration</a></li>
							<li><a href="./fixedheader.php">FixedHeader integration</a></li>
							<li><a href="./jqueryui.php">jQuery UI styling</a></li>
							<li><a href="./col_filter.php">Individual column filtering</a></li>
							<li><a href="./server_side.php">Server-side processing</a></li>
						</ul>
					</div>
				</div>
