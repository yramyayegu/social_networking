				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li><a href="./columns.php">Column options</a></li>
							<li><a href="./scrolling.php">Scrolling DataTable</a></li>
							<li><a href="./fill-both.php">Horizontal and vertical fill</a></li>
							<li><a href="./fill-horizontal.php">Horizontal fill</a></li>
							<li><a href="./complete-callback.php">Complete callback</a></li>
							<li><a href="./step-callback.php">Step callback</a></li>
						</ul>
					</div>
				</div>
