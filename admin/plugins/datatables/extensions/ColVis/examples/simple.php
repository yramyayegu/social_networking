				...
				<div class="toc">
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li><a href="./new_init.php">`new` initialisation</a></li>
							<li><a href="./text.php">Custom button text</a></li>
							<li><a href="./exclude_columns.php">Exclude columns from list</a></li>
							<li><a href="./title_callback.php">Column button callback</a></li>
							<li><a href="./button_order.php">Button ordering</a></li>
							<li><a href="./mouseover.php">Mouseover activation</a></li>
							<li><a href="./group_columns.php">Group columns</a></li>
							<li><a href="./two_tables.php">Two tables with individual controls</a></li>
							<li><a href="./two_tables_identical.php">Two tables with shared controls</a></li>
							<li><a href="./restore.php">Restore / show all</a></li>
