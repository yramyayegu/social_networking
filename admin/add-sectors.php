...
<script>
 ...
 $(document).ready(function()
...

	{
		...
		$.post("ajax-add-sectors.php",$("#formid").serialize(),function(output,status)
...
table();
			...
			{
				document.getElementById('msg').innerHTML='<b style="color:red" >Sector name requried</b>';	
			}
		table();
	});
});
  ...
  function table()
	{
		...
		$.post("ajax-add-sectors.php",{"tabkey":"some"},function(output,status)
		{
	...
	function saveData(save)
	{
		...
		$.post("ajax-add-sectors.php",{"leadid":save,"leadstatus":status1},
...
<h1 class="w3-panel w3-round w3-teal w3-margin w3-card-4">Add Sectors</h1>
<div class="w3-container">
  ...
  <form class="w3-container " action="" id="formid" method="post">
    ...
    <label class="w3-label w3-text-brown"><b>Sector Name</b></label>

    <input class="w3-input w3-border w3-sand" name="cname" id="cname" type="text" placeholder="Sector Name"></p>

   
    <p>

    <button class="w3-btn w3-brown">Add Sector</button></p>
