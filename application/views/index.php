	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo site_url('feed');?>" method="post">
					<span class="login100-form-title p-b-26">
						Login
					</span>
					<span class="login100-form-title p-b-48">
							<img style="margin: 10px 0px;" src="http://emc2india.com/images/emc2%20with%20gitam%20logo-1.jpg" alt="Logo">
					</span>
