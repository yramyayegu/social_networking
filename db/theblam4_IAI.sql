...
--
-- Host: localhost:3306
-- Generation Time: Jun 22, 2019 at 12:35 AM
...
(15, 8, '<p>The <strong>Wechsler</strong> Adult <strong>Intelligence Scale</strong> (<strong>WAIS</strong>) is an <strong>IQ test</strong> designed to <strong>measure intelligence</strong> and cognitive ability in adults and older adolescents. Below is a graph that represents the data points for students in schools across a country. 96% of students scored between <strong>_</strong><strong>_</strong><strong>_</strong> and <strong>_</strong>____</p><img src=\"queimg/q15.PNG\">', '85 and 115 points', '55 and 130 points', '70 and 130 points', '55 and 115 points', 3, 'MEDIUM', 'Statistics', ''),
(16, 8, '<p><strong>What can you infer from the below image?</strong></p><img src=\"queimg/q16.PNG\">', 'Average height of an women is higher than the average height of men', 'Average height of a man is 65 inches', 'The number of women having heights around the average woman height (65 inches) is more compared to the number of men having heights around the average man height (70 inches)', 'There are a lot of women whose height is around 85 inches', 3, 'HARD', 'Statistics', ''),
(17, 8, '<p><strong>Below heatmap represents the no.of passengers traveling via flights across time. Which months have the highest frequency of passengers?</strong></p><img src=\"queimg/q17.PNG\">', 'Jan and Feb', 'Jan and March', 'November and December', 'July and August', 4, 'EASY', 'Statistics', ''),
(18, 8, '<p><strong>Below are the no.of assault incidents that happened across 7 years in a town. Which of the below measures best describes this dataset?</strong></p> <p><strong>Assaults: 63, 71,74, 78, 87, 98,246</strong></p>', '63', '246', '78', '103', 3, 'MEDIUM', 'Statistics', ''),
(19, 8, '<p><strong>Below are the no.of car theft incidents that happened across 7 years in a town. Which of the below measures best describes this dataset?</strong></p> <p><br /><strong>Car Thefts : 65,70,72,74,180,201,203</strong></p>', '74', '65', '203', '120', 4, 'HARD', 'Statistics', ''),
...
(25, 8, '<p><strong>Which of the below features (columns) is least important for predicting whether someone is going to get a promotion or not? </strong></p>\r\n<img src=\"queimg/q25.PNG\">', 'Gender\r\n', 'Work Experience', 'Age', 'Salary', 1, 'MEDIUM', 'Statistics', ''),
(26, 8, '<p>Below is a confusion matrix that evaluates the classifications done by a Logistic Regression model. Can you calculate the accuracy of the model?</p>\r\n<p><img src=\"queimg/q26.PNG\" /></p>', '99.09%\r\n', '57.14%\r\n', '63.63%\r\n', '90.90%', 4, 'MEDIUM', 'Algebra', ''),
(27, 8, '<p>Below is a confusion matrix that evaluates the classifications done by a Logistic Regression model. Can you calculate the misclassification rate of the model?</p>\r\n<p><img src=\"queimg/q27.PNG\" /></p>', '90.90%', '57.14%', '9.09%', '63.63%', 3, 'EASY', 'Algebra', ''),
(28, 8, '<p><strong>Below is a confusion matrix that evaluates the classifications done by a Logistic Regression model. When its actually no, how often does the model predict no(Specificity)?</strong></p><p><img src=\"queimg/q28.PNG\" /></p>', '90.90%', '57.14%', '9.09%', '83.33%', 4, 'MEDIUM', 'Algebra', ''),
(29, 8, '<p>A decision tree model was used to predict whether a loan request is going to get approved or rejected. In the below &lsquo;Confusion Matrix&rsquo;, when the loan request was actually approved, how often is the prediction correct(Recall)?</p><p><img src=\"queimg/q29.PNG\" /></p>', '21.50%', '40%', '60%', '78.50%', 2, 'HARD', 'Algebra', ''),
...
(31, 8, '<p>What is the output of the below piece of code?&nbsp;</p>\r\n<p><br />a=\"Apples are better than \\\\n Oranges\"<br />print (a)</p>', '<p>Apples are better than <br />Oranges</p>', 'b.Apples are better than \\\\n Oranges', 'Apples are better than Oranges\r\n', 'Apples are better than \\n Oranges', 4, 'EASY', 'Programming', ''),
(32, 8, '<p>What is the output of the below piece of code?&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p>str_input=\"Hey how are you doing. I am doing great\"<br />print(str_input[:10]+\"_\"+str_input[-10:])</p>', 'Hey how are_doing great', 'great doing_am I doing. you are', 'Hey how ar_oing great', 'Hey how a_ing great', 3, 'EASY', 'Programming', ''),
(33, 8, '<p>What is the output of the below piece of code?</p>\r\n<p>string1=\"Hotelspace\"<br />string2=\"Facilities\"<br />m=string1[-3:]+string1[3:-3]+string1[:3]<br />n=string2[-3:]+string2[3:-3]+string2[:3]<br />m+\"@\"+n</p>', '\'aceelspHot@iesilitFac\'', '\'iesilitFac@aceelspHot\'', '\'Facilities@Hotelspace\'', '\'Hotelspace@Facilities\'', 1, 'HARD', 'Programming', ''),
(34, 8, '<p>What is the output of the below piece of code?</p>\r\n<img src=\"queimg/q34.PNG\">', 'It will print the numbers from 1 to 5', 'It will print the numbers from 1 to 10', 'It will print the numbers from 1 to 9', 'It will print the numbers from 1 to 6', 1, 'EASY', 'Programming', ''),
(35, 8, '<p>What is the output of the below piece of code?</p>\r\n<img src=\"queimg/q35.PNG\">', '13 is maximum', '12 is maximum', 'Syntax error', 'No output', 3, 'MEDIUM', 'Programming', ''),
(36, 8, '<p>What is the output of the below piece of code?</p>\r\n<p><img src=\"queimg/q36.PNG\"></p>', 'Execution stops with Zero Division error', 'Execution stops with Type Error error', 'Execution stops with the average output as 30', 'No errors and no output', 3, 'HARD', 'Programming', ''),
(37, 8, '<p>Jaccard Similarity is a measure that quantifies how similar two vectors are. In the below dataset, can you calculate the similarity between the ratings given by persons A and B: sim(A, B)?</p>\r\n<p><img src=\"queimg/q37.PNG\" /></p>', '0.4', '0.1', '0.2', '0.6', 3, 'MEDIUM', 'Algebra', ''),
(38, 8, '<p>Consider the ratings given by 4 people for some of the most popular movies of all-time. Which of the below options represents the relationship between similar users?</p>\r\n<p><img src=\"queimg/q27.PNG\" /></p>', 'SIM(A,B) > SIM(A,C)', 'SIM(A,C) < SIM(A,B)', 'SIM(A,B) = SIM(A,C)', 'none', 1, 'EASY', 'Algebra', ''),
(39, 8, 'Distance from the point (-3,-4) to the line 5x+6y-10 is', '7.5', '8.3', '2.5', '6.2', 4, 'HARD', 'Algebra', ''),
(40, 8, 'What is the euclidean distance between two points (4,5) and (5,6)?', '1.414', '2.828', '1.732', '3.456', 1, 'EASY', 'Algebra', ''),
(41, 8, '<p>Which of the below distance measures was used to determine the distance between points (13,5,8) and (11,2,1) as 7 units? </p>\r\n<p><img src=\"queimg/q41.PNG\" /></p>', 'Euclidean Distance', 'Manhattan Distance', 'Chebyshev Distance', 'None of the above', 3, 'MEDIUM', 'Algebra', ''),
...
(43, 8, 'Divakar received a total of 1500 emails, 950 emails are genuine and rest are spam. What is the probability of a spam email appearing in Divakar&rsquo;s account?', '0.63', '0.37', '0.5', '0.49', 2, 'EASY', 'Statistics', ''),
(44, 8, 'Below is a breakdown of the emails received by Divakar. What is the joint probability of word &lsquo;Jackpot&rsquo; appearing in spam emails?<img src=\"queimg/44.PNG\">', '13%', '14%', '27%', '15%', 1, 'MEDIUM', 'Statistics', ''),
(45, 8, 'What is the probability that an email is spam given that it contains the word &lsquo;Jackpot&rsquo;? Below is a breakdown of the emails.<img src=\"queimg/q45.PNG\">', '0.52', '0.48', '0.36', '0.24', 2, 'HARD', 'Statistics', ''),
(46, 8, 'There are 4 aces in a deck of cards. There are 52 outcomes in a deck of cards. There are 13 spades in a deck of cards. What is the probability of drawing an ace, replacing it and then drawing a spade?', '13/52', '4/52', '17/52', '1/52', 4, 'MEDIUM', 'Statistics', ''),
...
(48, 8, 'You are currently visiting France and a french colleague asked you “What is the salary of an Indian?”. If you have the salary details of all the 1.3 billion Indians, which central tendency measure will you cite as a response to your colleague&rsquo;s question?', 'Mode salary of an Indian', 'Mean salary of an Indian', 'Median salary of an Indian', 'Highest salary of an Indian\r\n', 3, 'MEDIUM', 'Statistics', ''),
(49, 8, 'You are presenting your annual hospital budget proposal for the upcoming year. You considered the last 12 months data. In the past year, there were two major epidemics in June and August. As a result, the number of patient admissions for the months of June and August are significantly higher than those of the rest of the months. If your goal is to make sure that the hospital has enough money to cater to the patients in the upcoming year, which of the below measures will you cite in your budget proposal? ', 'Median expenses incurred by the hospital in the last 12 months - I will not consider the months June and August as they seem to be outliers.', 'Mean expenses incurred by the hospital in the past 12 months - I will consider the months June and August even though they are outliers', 'Lowest monthly expense incurred by the hospital in the past 12 months and I multiply it by 12 to get the annual budget requirement', 'Most frequent monthly expense incurred by the hospital in the past 12 months and I multiply it by 12 to get the annual budget requirement.', 2, 'MEDIUM', 'Statistics', ''),
(50, 8, '<p>What are the three values in the yhat vector from the below equation? &lsquo;.&rsquo; represents a dot product between two vectors.</p><p><img src=\"queimg/q50.PNG\"></p>', '1.2, 2.4, -1.8', '0.5, 1, 1.3', '-1.6,2.4,1.2', '1.8,1.2,-3.0', 1, 'HARD', 'Algebra', ''),
(51, 8, '<p>Two matrices A and B are getting multiplied. A has 4 columns and 3 rows. B has 5 columns and 4 rows. What would be the order of the output matrix?</p>', '5 rows and 3 columns', '4 rows and 4 columns', '7 rows and 9 columns', '3 rows and 5 columns', 4, 'MEDIUM', 'Algebra', ''),
(52, 8, '<p>Find the slope of the line 5x-5y=7</p>', '5', '07', '7/5', '1', 4, 'MEDIUM', 'Algebra', ''),
(53, 8, '<p>Solve the equation |- 2 x + 2| - 3 = -3. What is the value of x?</p>', '0', '-1 or -2', '1', '2', 3, 'MEDIUM', 'Algebra', ''),
(54, 8, 'What are the values of a,b,c,d from the below equation?\r\n<p><img src=\"queimg/q54.PNG\"></p>', 'a=5, b=4, c=3, d=5', 'a=4,b=5,c=5,d=3', 'a=3,b=4,c=5,d=5', 'a=5,b=3,c=4,d=5', 1, 'HARD', 'Algebra', ''),
(55, 8, '<p>Apply the below decision tree for a fruit whose radius is 2.5 and color is &lsquo;Green&rsquo;. Can you tell which fruit is this?</p><p><img src=\"queimg/q11.PNG\"></p>', 'Apple', 'Lemon', 'Grape', 'Cannot say ', 1, 'MEDIUM', 'Algebra', ''),
(56, 8, '<p><strong><p>.Looking at the below decision tree for playing Golf, can you identify which of the conditions in the options is not correct?</p></strong></p>\r\n<br><img src=\"queimg/q56.PNG\">', 'IF outlook = sunny AND wind = False THEN play golf = No', 'IF outlook = rainy AND humidity = high THEN play golf = No', 'IF outlook = rainy AND humidity = Normal THEN play golf=Yes', 'IF outlook = sunny AND windy = True THEN play golf = No', 1, 'HARD', 'Algebra', ''),
(57, 8, '<p><strong>What would be the output of the below code?</strong></p><p><em>a=6.99</em><br /><em>b=7</em><br /><em>c=42</em><br /><em>print (not a == 7 and b == 7)</em></p>', 'True', 'False', 'No output', 'Error', 1, 'MEDIUM', 'Programming', ''),
(58, 8, '<p>What would be the output of the below code?</p>\r\n<p>list1=[\'sumana\',\'saru\',\'avinash\',\'abhi\',\'abhilash\']<br />print(sorted(list1,key=len,reverse=True))</p>', '[\'abhilash\', \'avinash\', \'sumana\', \'saru\', \'abhi\']', '[\'abhi\', \'abhilash ,\'avinash\', \'saru\', \'sumana\']', '[\'sumana\',\'saru\',\'avinash\',\'abhilash\',\'abhi\']', '[\'abhi, \'saru\', \'sumana\', \'avinash\', \'abhilash\']\r\n', 1, 'MEDIUM', 'Programming', ''),
(59, 8, '<p>What would be the output of the below code?<br />values = 1,2,3,4,5,7,6,3,2<br />y,x,z,d,c,b,a,w,h = values<br />print(c)</p>', 'Error', '2', '5', '(1,2,3,4,5,7,6,3,2)', 3, 'EASY', 'Programming', ''),
(60, 8, '<p>What would be the output of the below code?</p>\r\n<p><img src=\"queimg/q60.PNG\"></p>', '13', '-5', '2', 'Error', 3, 'HARD', 'Programming', ''),
...
(62, 8, '<p>In the below code, the value &lsquo;K&rsquo; is masking an actual numerical value. Can you look at the output and tell what the value of &lsquo;K&rsquo; should be? [Hard] [Programming]</p><p>import matplotlib.pyplot as plt</p><p># Pie chart, where the slices will be ordered and plotted counter-clockwise:<br />labels = &lsquo;Frogs&rsquo;, \'Hogs\', &rsquo;Dogs&rsquo;, &lsquo;Logs&rsquo;<br />sizes = [10, 30, 40, K]<br />explode = (0, 0, 0, 0) # only &lsquo;explode&rsquo; the 2nd slice (i.e. &lsquo;Hogs&rsquo;)<br />plt.pie(sizes, explode=explode, labels=labels, autopct=&lsquo;%1.1f%%&rsquo;,shadow=True, startangle=90)<br />plt.show()</p><p><img src=\"queimg/q62.PNG\"></p>', '15\r\n', '20', '16', '10', 4, 'HARD', 'Programming', ''),
(63, 8, '<p>What is the output of the below statement?</p>\r\n<p>&nbsp;</p>\r\n<p>[27*x for x in range(1,20) if x&lt;=5]</p>', '[27 27 27 27 27]', '[0 27 54 81 108 135]', '[27 54 81 108 135]', '[27 54 81 108 135 162]', 3, 'MEDIUM', 'Programming', ''),
(64, 8, '<p>What would be the output of the below code that reads the above text? [Hard] [Programming]</p><p>import re<br />match = re.search(r&rsquo;\\\\title\\s(\\d\\d\\d\\d)&rsquo;, text)<br />print (match)</p><img src=\"queimg/q64.PNG\">', '\\\\title 1996', '\\\\title 2123', '\\\\title 1996 \\\\title 2123', '\\\\title 19965', 1, 'HARD', 'Programming', ''),
(65, 8, '<p>What would be the output of the below code that reads the above text? [Hard] [Programming]</p><p>import re<br />matches = re.findall(r&rsquo;\\\\title\\s(\\d\\d\\d\\d)&rsquo;, text)<br />print (matches)<br />print (match)</p><img src=\"queimg/q64.PNG\">', '[19965]\r\n', '[19965 2123]', '[2123]', '[1996 2123]', 4, 'HARD', 'Programming', ''),
(66, 8, '<p>What is the output of the below code?<br />x = 50<br />def func(x):<br />x = 2<br />x=50.0<br />func(x)<br />print(x)</p>', '2', 'No output/Error', '50.0', '50', 4, 'MEDIUM', 'Programming', ''),
(67, 8, '<p>What would be the output of the below code?</p><p>def func(a, b=5, c=10):<br />print(&lsquo;a is&rsquo;, a, &lsquo;and b is&rsquo;, b, &lsquo;and c is&rsquo;, c)<br />func(25, c=24)</p>', 'a is 25 and b is 5 and c is 24', 'a is 0 and b is 25 and c is 24', 'a is 0 and b is 5 and c is 10', 'Error', 1, 'MEDIUM', 'Programming', '');
...
INSERT INTO `mst_result` (`id`, `login`, `test_id`, `totalquestion`, `trueanswer`, `wronganswer`, `totaleasy`, `totalmedium`, `totalhard`, `totalstat`, `totalalg`, `totalprog`, `score`, `totalpoints`, `end_time`, `test_date`, `AIquotient`) VALUES
(1, '3', 8, 20, 6, 14, 4, 1, 1, 4, 1, 1, 6, 100, 1550223469, '2019-02-15 13:47:49', '333.33333333333'),
(2, '12', 8, 20, 6, 14, 4, 1, 1, 3, 2, 1, 6, 100, 1550227672, '2019-02-15 14:57:52', '333.33333333333'),
(3, '17', 8, 20, 4, 16, 3, 1, 0, 2, 0, 2, 4, 50, 1550827237, '2019-02-22 13:30:37', '166.66666666667'),
(4, '18', 8, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 0, 1550828115, '2019-02-22 13:45:15', ''),
(5, '20', 8, 0, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 0, 1550911835, '2019-02-23 13:00:35', '');
